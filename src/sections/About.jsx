      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
            ...
            <div className="grid-container">
              ...
              <div>
                ...
                <p className="grid-subtext">
                  ...
                  I enjoy creating efficient, scalable solutions
                  and exploring new technologies to bring ideas to life. Always
        ...
        <div className="xl:col-span-1 xl:row-span-1">
          <div className="grid-container">
            ...
            <div className="space-y-2"><p className="grid-subtext text-center">Contact Me</p><div className="copy-container" onClick={handleCopy}>
              <img src={hasCopied ? 'assets/tick.svg' : 'assets/copy.svg'} /></div>
            <p className="lg:text-xl md:text-xl font-medium text-gray_gradient text-white text-center ">ahgamasundar40@gmail.com</p></div>
          </div>
